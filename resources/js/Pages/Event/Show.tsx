...
export default function Show() {
  ...
  const donators = Array.isArray(props.donators) 
    ? props.donators as Donation[]
    : props.donators?.data as Donation[] || [];
              ...
              <Card className="w-1/3 shrink-0">
                ...
                <CardContent> 
                  {donators.length > 0 ? (
                    ...
                    <p className="text-gray-600 text-lg mb-2 font-bold">No Donations Yet</p>
                    <p className="text-gray-500 text-sm text-center">
                      Be the first to support this event! Your contribution can make a difference.
                    </p>
                  </div>
                  )}
                </CardContent>
