              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-6">
                  <p className="text-lg text-gray-700">
                    Your donation helps us continue our mission to create a
                    greener, more sustainable future. Every contribution, no
                    matter how small, makes a significant impact on our
                  ...
                  <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                    {[10000, 25000, 50000].map((amount) => (
                      ...
                      >
                        ...
                        >
                          <Link href={route("event.index")}>
                            <Heart className="mr-2 h-4 w-4" /> Donate Rp{" "}
                            {amount}
                          </Link>
                        </Button>
                      </motion.button>
